package org.unina.spatialanalysis.routegridanalyzer.map;
...
public class SelectionAdapter extends MouseAdapter 
{
    ...
    // private Point2D startCoord = new Point2D.Double();
    // private Point2D endCoord = new Point2D.Double();
	...
	public GeoPosition getStartPos() {
		return this.viewer.convertPointToGeoPosition(startPos);
	}

	public GeoPosition getEndPos() {
		return this.viewer.convertPointToGeoPosition(endPos);
	}
