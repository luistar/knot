 ...
 */
public class RouteGridAnalyzerNodePlugin extends Plugin {
    // The shared instance.
    private static RouteGridAnalyzerNodePlugin plugin;

    /**
     * The constructor.
     */
    public RouteGridAnalyzerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static RouteGridAnalyzerNodePlugin getDefault() {
        return plugin;
    }
