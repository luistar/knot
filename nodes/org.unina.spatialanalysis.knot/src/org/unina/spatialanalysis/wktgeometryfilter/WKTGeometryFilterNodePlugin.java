 ...
 */
public class WKTGeometryFilterNodePlugin extends Plugin {
    // The shared instance.
    private static WKTGeometryFilterNodePlugin plugin;

    /**
     * The constructor.
     */
    public WKTGeometryFilterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static WKTGeometryFilterNodePlugin getDefault() {
        return plugin;
    }
