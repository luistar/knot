 ...
 * @author Sinogrante
 */
public class RouteCalculatorNodePlugin extends Plugin {
    // The shared instance.
    private static RouteCalculatorNodePlugin plugin;

    /**
     * The constructor.
     */
    public RouteCalculatorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static RouteCalculatorNodePlugin getDefault() {
        return plugin;
    }
