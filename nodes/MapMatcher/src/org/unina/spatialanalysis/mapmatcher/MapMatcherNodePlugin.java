 ...
 */
public class MapMatcherNodePlugin extends Plugin {
    // The shared instance.
    private static MapMatcherNodePlugin plugin;

    /**
     * The constructor.
     */
    public MapMatcherNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MapMatcherNodePlugin getDefault() {
        return plugin;
    }
