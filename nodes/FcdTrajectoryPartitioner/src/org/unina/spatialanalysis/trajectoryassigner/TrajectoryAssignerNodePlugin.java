 ...
 */
public class TrajectoryAssignerNodePlugin extends Plugin {
    // The shared instance.
    private static TrajectoryAssignerNodePlugin plugin;

    /**
     * The constructor.
     */
    public TrajectoryAssignerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static TrajectoryAssignerNodePlugin getDefault() {
        return plugin;
    }
